...
if (MainThreeScene.init(glContainer),
...
let thisClass, scrollFixCta, ctaFixIn, mouseX = 0, mouseY = 0, ballX = 0, ballY = 0, ballSpeed = .17, heroAnim = gsap.timeline({
    paused: !0
});
...
let shapeStart, page2, page3, menuMid, menuEnd, pageMaster = gsap.timeline({
    ...
    paused: !0
}), pageShape = document.querySelectorAll(".page-to-page svg"), easterPath = "M830 439.5C830 472.244 816.831 501.911 795.5 523.496C773.836 545.417 743.754 559 710.5 559C677.246 559 647.164 545.417 625.5 523.496C604.169 501.911 591 472.244 591 439.5C591 408.056 603.145 379.448 623 358.111C644.818 334.665 675.946 320 710.5 320C747.397 320 780.387 336.722 802.308 363C819.597 383.727 830 410.398 830 439.5Z";
if (isMobile()) {
    if (isMobile()) {
...
let smoother, easeValA = "M0,0 C0,0 0.236,-0.014 0.337,0.114 0.485,0.302 0.314,0.662 0.514,0.86 0.681,1.026 1,1 1,1", easeValB = "M0,0 C0,0 0.026,0.439 0.24,0.778 0.377,0.995 0.668,1 0.816,1 0.947,1 1,1 1,1", easeValC = "M0,0 C0.123,-0.014 0.24,0.031 0.306,0.078 0.537,0.241 0.441,0.677 0.56,0.836 0.626,0.924 0.698,1 1,1 ", customEaseA = CustomEase.create("custom", easeValA), customEaseB = CustomEase.create("custom", easeValB), customEaseC = CustomEase.create("custom", easeValC);
...
hamburger.addEventListener("click", (function() {
    ...
    hamburger.classList.contains("active") ? (hambIcon.reverse(),
    menuBgAnim.reverse(),
    menuInner.reverse(),
    ...
    isMobile() || smoother.paused(!1)) : (hambIcon.restart(),
    menuBgAnim.restart(),
    menuInner.restart(),
...
PageInits = {
    ...
    mainScripts: function() {
        ...
        if (document.querySelector(".timeline") && !isMobile()) {
            ...
            t.style.transform = `translateX(${c + "px"}) translateY(${n + "px"}) scale(.8)`,
            gsap.set(o, {
                opacity: 0
            });
        ...
        if (document.querySelector(".contact")) {
            ...
            e.forEach((e=>{
                e.addEventListener("click", (function() {
                    n = this.dataset.stepTarget,
                    i = this.dataset.previous;
                    ...
                    if (a.setAttribute("data-state", `${i}`),
                    gsap.to(a, {
                        opacity: 1,
                        duration: .4,
                        pointerEvents: "auto",
                    ...
                    o.forEach((e=>{
                        e.addEventListener("click", (function() {
                            ...
                            gsap.to(o, {
                                ...
                                duration: 1,
                                ease: customEaseC
                            })) : e.classList.contains("selected") || e.classList.contains("disabled") || !i ? e.classList.contains("selected") && !e.classList.contains("disabled") && i && (e.classList.remove("selected"),
                            t.classList.remove("active"),
                            gsap.to(a, {
                                x: "0",
                                delay: .1,
...
changeTheme();
const glIn = function() {
    bodyTag.classList.contains("init") && !isMobile() && (MainThreeScene.start(),
    gsap.set(glContainer, {
        y: e=>"+=" + -1 * e.offsetHeight,
        zIndex: 10
    })),
    bodyTag.classList.contains("init") || bodyTag.classList.contains("root") || bodyTag.classList.contains("default") || isMobile() || (MainThreeScene.start(),
    gsap.set(glContainer, {
        y: e=>"+=" + -1 * e.offsetHeight,
        zIndex: 2
    }))
  ...
  , glOut = function() {
    bodyTag.classList.contains("init") && !isMobile() && (MainThreeScene.pause(),
    gsap.set(glContainer, {
        y: e=>"+=" + -1 * e.offsetHeight,
        zIndex: 2
    })),
    bodyTag.classList.contains("init") || bodyTag.classList.contains("root") || bodyTag.classList.contains("default") || isMobile() || (MainThreeScene.pause(),
    gsap.set(glContainer, {
        y: e=>"+=" + -1 * e.offsetHeight,
        zIndex: 10
    }))
...
const updateGl = function() {
    ...
    bodyTag.classList.contains("root") ? (MainThreeScene.pause(),
    gl.disable()) : (gsap.to(glContainer, {
        zIndex: 2,
        opacity: 1,
        scale: .7,
        xPercent: 0,
    ...
    gl.enable()),
    bodyTag.classList.contains("default") && gsap.to(glContainer, {
        zIndex: 999,
        opacity: 1,
        scale: .7,
        xPercent: 0,
    ...
    MainThreeScene.start()),
    bodyTag.classList.contains("default") && isMobile() && (gsap.to(glContainer, {
        zIndex: 999,
        opacity: 1,
        scale: 1,
        opacity: 1,
...
const changeTexture = function() {
    bodyTag.classList.contains("default") && (MainThreeScene.changeTexture(0, !1),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 1909061
        }
    })),
    bodyTag.classList.contains("ssi") && (MainThreeScene.changeTexture(0),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 16777215
        }
    })),
    bodyTag.classList.contains("op") && (MainThreeScene.changeTexture(1),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 6841187
        }
    })),
    bodyTag.classList.contains("va") && (MainThreeScene.changeTexture(2),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 15592674
        }
    })),
    bodyTag.classList.contains("hy") && (MainThreeScene.changeTexture(3),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 15592674
        }
    })),
    bodyTag.classList.contains("oa") && (MainThreeScene.changeTexture(4),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 15462387
        }
    })),
    bodyTag.classList.contains("be") && (MainThreeScene.changeTexture(5),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 6254957
        }
    })),
    bodyTag.classList.contains("hp") && (MainThreeScene.changeTexture(6),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 15658473
        }
    })),
    bodyTag.classList.contains("ho") && (MainThreeScene.changeTexture(7),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 15463134
        }
    })),
    bodyTag.classList.contains("md") && (MainThreeScene.changeTexture(8),
    MainThreeScene.setParams({
        mainBall: {
            reflectionColor: 15660799
        }
    })),
    bodyTag.classList.contains("init") && (MainThreeScene.changeTexture(9, !1),
    MainThreeScene.setParams({
        mainBall: {
...
$((function() {
    ...
    var e = {
        ...
        onAfter: function(e, t) {
            ...
            changeTheme(),
            bodyTag.classList.contains("default") || bodyTag.classList.contains("init") || bodyTag.classList.contains("root") ? (updateGl(),
            changeTexture(),
            gsap.to(".blur-circle", {
                scale: 1,
                opacity: .3,
